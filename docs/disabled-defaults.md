...
> Auto-generated by `scripts/atlas.mjs` on 2026-09-16. Which upstream-enabled skills are systematically turned off by forks?
...
Ships **2** skill(s) enabled by default. Disable rates across **261** forks:

| Skill | Disabled by | Rate |
|---|---:|---:|
| `auto-workflow` | 181 / 261 | **69%** |
| `heartbeat` | 3 / 261 | **1%** |
