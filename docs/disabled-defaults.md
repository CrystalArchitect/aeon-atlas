...
> Auto-generated by `scripts/atlas.mjs` on 2026-09-20. Which upstream-enabled skills are systematically turned off by forks?
...
Ships **2** skill(s) enabled by default. Disable rates across **260** forks:

| Skill | Disabled by | Rate |
|---|---:|---:|
| `auto-workflow` | 181 / 260 | **70%** |
| `heartbeat` | 2 / 260 | **1%** |
